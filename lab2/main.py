...
from algorithms import Algorithm, SolvingAlgorithm, heuristic_game_score
...
if __name__ == '__main__':
    ...
    # ar1 = tuple(tuple(0 for i in range(8)) for _ in range(8))
    # ar1[0][0] = 5
    # ar2 = ar1.copy()
    # ar2[0][1] = 3
    # print(ar1)
